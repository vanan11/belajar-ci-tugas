...
$hlm = "Home";
if(uri_string()!=""){
    // Menggunakan str_replace untuk mengganti '/' dengan ' - ' jika ada di URI
...
<!-- Select2 JS (dipindahkan ke body, setelah jQuery) -->
